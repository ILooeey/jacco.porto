...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['currentPassword'], $_POST['newPassword'], $_POST['confirmNewPassword']) && !empty($_POST['currentPassword']) && !empty($_POST['newPassword']) && !empty($_POST['confirmNewPassword'])) {
        if ($_POST['newPassword'] === $_POST['confirmNewPassword']) {
            ...
            $query = "UPDATE data_user SET Password = ? WHERE Password = ?";
            ...
            <div class="card-body auto">
                ...
                <ul class="list-group list-group-flush mt-3">
                    ...
                    if (isset($_SESSION['session_email'])) {
                        ...
                        if ($akun) {
                            foreach ($akun as $a) {
                                $id_gender = $a['id_Jenis_Kelamin'];
                                $gender = $model->gender($id_gender);
                                echo '<ul class="list-group">';
                                echo '<li class="list-group-item">Nama: <span class="float-end">' . htmlspecialchars($a['Nama_User']) . '</span></li>';
                                echo '<li class="list-group-item">Nomor: <span class="float-end">' . htmlspecialchars($a['Nomor_Telepon']) . '</span></li>';
                                ...
                                echo '<li class="list-group-item">Jenis Kelamin: <span class="float-end">' . htmlspecialchars($gender) . '</span></li>';
                                echo '</ul>';
                            }
                        }
                    }
